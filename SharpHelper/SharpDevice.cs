...
namespace SharpHelper
{
	...
	public class SharpDevice : IDisposable
	{
		...
		/// <summary>
		/// Set current rasterizer state to a new rasterizer state based on the input description
		/// </summary>
		/// <param name="rasterDescription">Description</param>
		public void SetRasterState(RasterizerStateDescription rasterDescription)
		{
			_rasterState.Dispose();
			_rasterState = new RasterizerState(Device, rasterDescription);
